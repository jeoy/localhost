...
(function($, window, document, Math, undefined) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
		...
		FP.setScrolling = function (value){
            if(value){
        ...
        */
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                var li = '<li><a href="#' + link + '"><span ><p></br> '+options.nav_name[i] +'</p> </span></a>';
                ...
                if(canScroll){
                    ...
                    if(isAccelerating){
                        ...
                        if (delta < 0) {
							...
							if($(".section.active").index(".section")==($(".section").size()-1)){
								$(".section.active").addClass("foot");
							}
							canScroll = false;
							setTimeout(function(){
								canScroll = true;	
							...
							//æ¸è¿›æ¸å‡º
							if($(".section.active .opacity").size()>0){
								var _section = $(".section.active");
								if(_section.find(".opacity.active").size()==0){
									_section.find(".opacity").eq(0).addClass("active");
								}
								var _selfopacity = _section.find(".opacity.active");
								
								var num = _section.find(".opacity").size() - 1;  //
								var index = _section.find(".opacity").index(_selfopacity);  //
								if(num == index ){
									//_selfopacity.removeClass("active");
									//_section.find(".opacity").eq(0).addClass("active");
								}else{
									_section.find(".opacity.active").next().addClass("active");
									_selfopacity.removeClass("active");
									return;	
								}
							...
							if(options.hscroll){  //å…è®¸æ¨ªå±
								//å½“å‰é€‰ä¸­
								var $nowSetion = $("[data-anchor=" + lastScrolledDestiny + "]");
								if($nowSetion.find(".slide").size()>1){
									var i = $nowSetion.find(".slide").index($nowSetion.find(".slide.active"));
									if(i+1==$nowSetion.find(".slide").size()){
										 scrolling('down', scrollable);
										 return;
									}
									FP.moveSlideRight();
                        ...
                        //scrolling up?
							...
							if($(".section.active").index(".section")==($(".section").size()-1)&&$(".section.active").hasClass("foot")){
								$(".section.active").removeClass("foot");
								return;
							}
							...
							if($(".section.active .opacity").size()>0){
								var _section = $(".section.active");
								if(_section.find(".opacity.active").size()==0){
									_section.find(".opacity").eq($(".section.active .opacity").size()-1).addClass("active");
								}
								...
								if(index == 0){
									...
									_section.find(".opacity.active").prev().addClass("active");
									_selfopacity.removeClass("active");
									return;	
								}
